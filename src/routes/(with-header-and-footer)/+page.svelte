...
<a
href="/products"
class="mt-8 inline-block rounded-md border border-transparent bg-purple-500 py-3 px-8 text-base font-medium text-gray-900 hover:bg-gray-100"
data-ai-description="the main CTA button on the landing page">All products here!</a
>
	</div>
</div>
			...
			<div class="relative bg-gray-900 bg-opacity-75 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
				<div class="relative mx-auto flex max-w-3xl flex-col items-center text-center">
					...
					<p class="mt-3 text-xl text-white">
						...
						doing our best here. No kanban boards, burndown charts, or tangled flowcharts with our
