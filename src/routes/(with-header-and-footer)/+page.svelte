...
<div class="relative bg-gradient-to-b from-green-200 to-green-900">
  ...
  <div aria-hidden="true" class="absolute inset-0 bg-gradient-to-b from-black to-gray-900 opacity-50" />
...
>
    <div class="relative overflow-hidden rounded-lg">
        ...
        <div class="relative bg-gray-900 bg-opacity-75 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
            <div class="relative mx-auto flex max-w-3xl flex-col items-center text-center">
                <h2 id="subscriptions-heading" class="text-3xl font-bold tracking-tight text-white sm:text-4xl">
