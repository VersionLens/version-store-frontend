...
<dt class="text-base font-medium text-gray-900">Number of items</dt>
<dd class="ml-4 text-base font-medium text-gray-900">{$basket.data.basket.items.length}</dd>
							</div>
						</dl>
					...
					<div class="mt-10">
						<button
on:click={() => navigateToPurchaseCompletedPage()}
